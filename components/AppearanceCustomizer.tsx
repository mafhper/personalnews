      ...
      <div className="space-y-6">
        ...
        <div className="min-h-[400px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {LAYOUT_PRESETS.map((preset) => (
                  <Card
                    key={preset.id}
                    variant="outline"
                    className="cursor-pointer hover:border-[rgb(var(--color-accent))] hover:bg-white/5 transition-all group"
                    onClick={() => applyLayoutPreset(preset.id)}
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="text-lg font-semibold text-white group-hover:text-[rgb(var(--color-accent))] transition-colors">
                        {preset.name}
                      </h3>
              ...
              {editingTheme ? (
                ...
                <>
                  ...
                  {customThemes.length > 0 && (
                    <div className="mt-8">
                      <h3 className="text-lg font-semibold text-white mb-4">My Custom Themes</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {activeTab === "header" && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <Card variant="glass" className="p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Header Style</h3>
              ...
              <Card variant="glass" className="p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Header Position</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          {activeTab === "content" && (
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <Card variant="glass" className="p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Layout Density</h3>
