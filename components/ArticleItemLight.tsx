    ...
    <article className={`h-full flex flex-col ${className}`}>
      <div className="feed-card feed-card--flat flex flex-col h-full group p-4 sm:p-5">
        ...
        <div className="flex-1 flex flex-col">
          <button
            type="button"
            className="flex-1 flex flex-col group bg-transparent p-0 text-left"
          ...
          >
            ...
            <div className="mt-auto flex flex-wrap items-center gap-x-3 gap-y-1">
              {authorLabel && (
                <span
                  className="feed-meta text-[11px] truncate max-w-[180px]"
                  title={authorLabel}
                >
                  {authorLabel}
                </span>
              ...
              <time
                className="feed-meta feed-meta-hoverable text-[10px] uppercase tracking-[0.18em] block w-fit"
