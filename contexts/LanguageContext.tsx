...
const translations: Record<Language, Record<string, string>> = {
  ...
  'en-US': {
    ...
    'header.manage_feeds': 'Manage Feeds',
  ...
  'fr': {
    ...
    'header.manage_feeds': 'Gérer les flux',
    ...
    'feeds.title': 'Gérer Flux',
    'feeds.tab.feeds': 'Flux',
    ...
    'feeds.stats.monitored': 'flux suivis',
    ...
    'analytics.feed_status': 'État des Flux',
  ...
  'ja': {
    ...
    'action.remove': '削除',
    'header.manage_feeds': 'フィード管理',
    'header.refresh': 'フィード更新',
    'header.settings': '設定',
