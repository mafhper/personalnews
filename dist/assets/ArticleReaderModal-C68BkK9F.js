import{r as s,j as e}from"./performance-DGmBAmJn.js";import{g as z}from"./videoEmbed-D9D8KXWZ.js";import{f as B}from"./articleFetcher-CV-NqR0N.js";import{b as E,p as R,o as T}from"./index-Cghj9Ouz.js";const _={fontSize:"medium",lineHeight:"relaxed",contentWidth:"medium",fontFamily:"serif"},U=({article:o,onClose:d,onNext:b,onPrev:m,hasNext:x,hasPrev:g})=>{const k=z(o.link),[j,w]=s.useState(null),[W,y]=s.useState(!1),[a,N]=s.useState(!1),[c,S]=s.useState(!1),{t:n}=E(),{setModalOpen:f}=R(),v=s.useRef(null),h=s.useRef(null),[t,C]=T("reader-preferences",_),L={small:"text-base leading-relaxed",medium:"text-lg leading-relaxed",large:"text-xl leading-relaxed",xlarge:"text-2xl leading-relaxed"},$={compact:"leading-normal",normal:"leading-relaxed",relaxed:"leading-loose"},M={narrow:"max-w-xl",medium:"max-w-2xl",wide:"max-w-4xl"},p={serif:"font-serif",sans:"font-sans",mono:"font-mono"},u=s.useCallback((r,i)=>{C(l=>({...l,[r]:i}))},[C]);s.useEffect(()=>{f(!0),w(null),y(!0),h.current&&h.current.focus(),v.current&&(v.current.scrollTop=0),(async()=>{const l=await B(o.link);l&&w(l),y(!1)})();const i=l=>{l.key==="Escape"&&(c?S(!1):d()),l.key==="ArrowRight"&&x&&b(),l.key==="ArrowLeft"&&g&&m(),l.key==="f"&&N(H=>!H)};return window.addEventListener("keydown",i),()=>{window.removeEventListener("keydown",i),f(!1)}},[o.link,d,b,m,x,g,f,c]);const q=r=>r?/<[a-z][\s\S]*>/i.test(r)?r:r.split(/\n\n+/).map(l=>`<p class="mb-4">${l.trim()}</p>`).join("").replace(/\n/g,"<br />"):"",F=q(j||o.content||o.description);return e.jsxs("div",{ref:h,tabIndex:-1,className:`fixed inset-0 z-[200] flex items-center justify-center animate-in fade-in duration-300 outline-none ${a?"bg-[rgb(var(--color-background))]":"p-0 md:p-8 bg-black md:bg-black/80"}`,children:[e.jsx("style",{children:`
        .article-content {
          font-family: inherit;
          line-height: inherit;
          color: inherit;
