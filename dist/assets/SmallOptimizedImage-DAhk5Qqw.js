import{r as t,R as S,j as a}from"./performance-CYiPyM9i.js";const I=({src:e,alt:u,className:f="",fallbackText:n,size:h,height:v,priority:w=!1})=>{const[o,s]=t.useState("loading"),[b,r]=t.useState(e),[c,d]=t.useState(0),g=v||h,m=h,i=t.useCallback((l,x)=>{const j="374151",$="9CA3AF";switch(l){case 0:return x||"";case 1:return`data:image/svg+xml,${encodeURIComponent(`
