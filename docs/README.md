...
- [Guide to `package.json` scripts](package-scripts-guia.md): the most useful local commands for development, validation, and contributor-oriented checks.

## Start here

- If you want to understand the product architecture, start with [technical-overview.md](technical-overview.md).
- If you want to contribute code, also read [../CONTRIBUTING.md](../CONTRIBUTING.md).
